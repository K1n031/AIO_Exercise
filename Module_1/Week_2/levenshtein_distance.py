def levenshtein_distance(source, target):
    ...
    distance_matrix = [[0 for _ in range(len_target + 1)] for _ in range(len_source + 1)]
...
source = "kitten"
target = "sitting"
print(f"Levenshtein distance of '{source}' and '{target}' is: {levenshtein_distance(source, target)}")
